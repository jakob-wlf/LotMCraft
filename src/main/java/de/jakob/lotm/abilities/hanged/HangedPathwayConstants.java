...
public final class HangedPathwayConstants {
    ...
    public static final int SEQUENCE_BLACK_KNIGHT = 4;
    public static final int SEQUENCE_TRINITY_TEMPLAR = 3;
    public static final int SEQUENCE_PROFANE_PRESBYTER = 2;
    public static final int SEQUENCE_DARK_ANGEL = 1;
    ...
    public static final float TOTAL_SPIRITUALITY_SEQUENCE_4 = 13650.0f;
    public static final float TOTAL_SPIRITUALITY_SEQUENCE_3 = 22000.0f;
    public static final float TOTAL_SPIRITUALITY_SEQUENCE_2 = 32000.0f;
    public static final float TOTAL_SPIRITUALITY_SEQUENCE_1 = 45000.0f;
