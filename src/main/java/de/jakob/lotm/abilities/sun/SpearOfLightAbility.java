...
public class SpearOfLightAbility extends Ability {
    ...
    public void onAbilityUse(Level level, LivingEntity entity) {
        ...
        SpearOfLightProjectileEntity spear = new SpearOfLightProjectileEntity(level, entity, DamageLookup.lookupDamage(2, .75) * (int) multiplier(entity), BeyonderData.isGriefingEnabled(entity), this);
