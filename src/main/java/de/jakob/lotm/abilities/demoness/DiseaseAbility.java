...
public class DiseaseAbility extends Ability {
    ...
    public void onAbilityUse(Level level, LivingEntity entity) {
        ...
        ServerScheduler.scheduleForDuration(0, 20, 20 * 80, () -> {
            ...
            AbilityUtil.damageNearbyEntities((ServerLevel) entity.level(), entity, 40, (float) DamageLookup.lookupDps(5, .2, 20, 20) * (float) multiplier(entity) * damageMult, entity.position(), true, false, true, 0);
