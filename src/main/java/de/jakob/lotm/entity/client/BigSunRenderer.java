...
public class BigSunRenderer extends EntityRenderer<BigSunEntity> {
    ...
    @Override
    public void render(BigSunEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    protected int getBlockLightLevel(BigSunEntity entity, BlockPos pos) {
        return 15;
    }
