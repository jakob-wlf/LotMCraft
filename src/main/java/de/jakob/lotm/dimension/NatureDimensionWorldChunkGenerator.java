...
public class NatureDimensionWorldChunkGenerator extends ChunkGenerator {

    public static final MapCodec<NatureDimensionWorldChunkGenerator> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    BiomeSource.CODEC.fieldOf("biome_source").forGetter(ChunkGenerator::getBiomeSource)
            ).apply(instance, NatureDimensionWorldChunkGenerator::new)
    );

    private final PerlinSimplexNoise surfaceNoise;
    private final PerlinSimplexNoise patchNoise;

    public NatureDimensionWorldChunkGenerator(BiomeSource biomeSource) {
        super(biomeSource);
    ...
    public void addDebugScreenInfo(List<String> list, RandomState randomState, BlockPos blockPos) {
        list.add("Nature World Generator");
