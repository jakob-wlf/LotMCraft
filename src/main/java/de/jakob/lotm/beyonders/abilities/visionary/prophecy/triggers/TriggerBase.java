...
import de.jakob.lotm.beyonders.abilities.visionary.prophecy.triggers.implementations.*;
...
public abstract class  TriggerBase {
    ...
    public static TriggerBase load(TriggerEnum type, CompoundTag tag, HolderLookup.Provider provider) {
        ...
        return switch (type) {
            ...
            case CHAIN -> ChainTrigger.load(tag, actionType, contextType, provider);
            };
    }
    ...
    public static TriggerBase create(TriggerEnum type, ActionBase action, TriggerContextBase context){
        return switch (type){
            ...
            case CHAIN -> new ChainTrigger(action, context);
        };
    }
}
