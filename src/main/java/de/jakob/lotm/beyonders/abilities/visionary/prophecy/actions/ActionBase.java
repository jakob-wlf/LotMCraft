...
import de.jakob.lotm.beyonders.abilities.visionary.prophecy.actions.implementations.*;
...
public abstract class ActionBase {
    ...
    public static ActionBase load(ActionsEnum type, CompoundTag tag, HolderLookup.Provider provider) {
        return switch (type) {
            ...
            case AGGRO -> AggroAction.load(tag, provider);
            case MOVE -> MoveAction.load(tag, provider);
        };
    }
    ...
    public static ActionBase create(ActionsEnum type, ActionContextBase context){
        return switch (type){
            ...
            case AGGRO -> new AggroAction(context);
            case MOVE -> new MoveAction(context);
        };
    }
}
