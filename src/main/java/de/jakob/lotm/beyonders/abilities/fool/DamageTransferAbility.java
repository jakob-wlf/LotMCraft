...
public class DamageTransferAbility extends SelectableAbility {
    ...
    protected String[] getAbilityNames() {
        return new String[]{
                "ability.lotmcraft.damage_transfer.self",
                "ability.lotmcraft.damage_transfer.others"
        };
    }
    ...
    protected void castSelectedAbility(Level level, LivingEntity entity, int selectedAbility) {
        ...
        LivingEntity target = selectedAbility == 0 ?
                entity :
                AbilityUtil.getTargetEntity(entity, 3, 2, true, true);
