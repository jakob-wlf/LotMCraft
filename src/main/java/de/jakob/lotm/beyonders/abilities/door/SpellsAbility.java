...
public class SpellsAbility extends SelectableAbility {
    ...
    private void tumble(Level level, LivingEntity entity) {
        ...
        Vec3 targetLoc = AbilityUtil.getTargetLocation(entity, (int) (12*multiplier(entity)), 1);
    ...
    private void freeze(Level level, LivingEntity entity) {
        ...
        Vec3 targetPos = AbilityUtil.getTargetLocation(entity, (int) (4*multiplier(entity)), 2);
    ...
    private void electricShock(Level level, LivingEntity entity) {
        ...
        Vec3 direction = AbilityUtil.getTargetLocation(entity, (int) (15*multiplier(entity)), 1.4f).subtract(start).normalize();
        ...
        ElectricShockEntity shock = new ElectricShockEntity(level, entity, start, direction, 30, DamageLookup.lookupDamage(8, .7) *multiplier(entity));
    ...
    private void wind(Level level, LivingEntity entity) {
        ...
        ServerScheduler.scheduleForDuration(0, 1, (int) (20 * 6*multiplier(entity)), () -> {
