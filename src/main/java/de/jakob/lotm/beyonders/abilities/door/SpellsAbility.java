...
public class SpellsAbility extends SelectableAbility {
    ...
    public SpellsAbility(String id) {
        ...
        dynamicSpirituality = new LinkedList<>(List.of(4500f, 2000f, 1200f, 750f, 680f, 570f, 400f, 290f, 150f));
    ...
    protected String[] getAbilityNames() {
        return new String[]{
                "ability.lotmcraft.spells.wind",
                "ability.lotmcraft.spells.electric_shock",
                "ability.lotmcraft.spells.freeze",
                "ability.lotmcraft.spells.flash",
                "ability.lotmcraft.spells.fog",
                "ability.lotmcraft.spells.tumble",
                "ability.lotmcraft.spells.burning"
        };
    }
    ...
    private void tumble(Level level, LivingEntity entity) {
        ...
        Vec3 targetLoc = AbilityUtil.getTargetLocation(entity, baseDistance, 1);
        ...
        ServerScheduler.scheduleForDuration(0, 5, 20 * 2, () -> {
    ...
    private void freeze(Level level, LivingEntity entity) {
        ...
        AbilityUtil.damageNearbyEntities((ServerLevel) level, entity, 2.5, ModDamageTypes.WATER, baseDamage, targetPos, true, false);
    ...
    private void flash(Level level, LivingEntity entity) {
        ...
        if (!level.isClientSide) {
            ...
            AbilityUtil.addPotionEffectToNearbyEntities((ServerLevel) level, entity, 5, targetLoc, new MobEffectInstance(MobEffects.BLINDNESS, 20 * 2, 50, false, false, false), new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 20 * 2, 5, false, false, false));
    ...
    private void electricShock(Level level, LivingEntity entity) {
        ...
        Vec3 direction = AbilityUtil.getTargetLocation(entity, baseDistance, 1.4f).subtract(start).normalize();
        ...
        ElectricShockEntity shock = new ElectricShockEntity(level, entity, start, direction, 30, baseDamage);
