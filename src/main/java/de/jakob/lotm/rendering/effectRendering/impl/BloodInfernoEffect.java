...
public class BloodInfernoEffect extends ActiveEffect {
        ...
        for (int wave = 0; wave < 5; wave++) {
            ...
            for (int i = 0; i < segments; i++) {
                ...
                for (int j = 0; j <= 40; j++) {
                    ...
                    buffer.addVertex(matrix, x, h1, z).setColor(0.9f, 0.1f, 0.0f, a);
                    buffer.addVertex(matrix, x, h2, z).setColor(0.9f, 0.1f, 0.0f, a);
                }
