...
public class FearAuraEffect extends ActiveMovableEffect {
    ...
    public FearAuraEffect(Location location, int maxDuration, boolean infinite) {
    ...
    private void renderDarknessLayer(VertexConsumer consumer, Matrix4f matrix, DarknessLayer layer) {
        ...
        for (int h = 0; h < 8; h++) {
            ...
            for (int i = 0; i < segments; i++) {
                ...
                addVertex(consumer, matrix, x2, y2, z2, r * 1.2f, g * 1.2f, b, layer.alpha);
                addVertex(consumer, matrix, x1, y2, z1, r * 1.2f, g * 1.2f, b, layer.alpha);
            }
        }
    }
    ...
    private void renderTentacle(VertexConsumer consumer, Matrix4f matrix, DarknessTentacle tentacle) {
        ...
        for (int i = 0; i < segments - 1; i++) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                addVertex(consumer, matrix, (float) c2b.x, (float) c2b.y, (float) c2b.z, r * 1.3f, g, b, alpha);
                addVertex(consumer, matrix, (float) c2a.x, (float) c2a.y, (float) c2a.z, r * 1.3f, g, b, alpha);
            }
        }
    }
    ...
    private void renderDarknessSpike(VertexConsumer consumer, Matrix4f matrix, DarknessSpike spike) {
        ...
        for (int i = 0; i < sides; i++) {
            ...
            addVertex(consumer, matrix,
                    ...
                    r, g, b, spike.alpha);
            addVertex(consumer, matrix, tipX, tipY, tipZ, r * 2f, g, b, spike.alpha * 0.7f);
            addVertex(consumer, matrix, tipX, tipY, tipZ, r * 2f, g, b, spike.alpha * 0.7f);
        }
    }
    ...
    private void renderDarknessWall(VertexConsumer consumer, Matrix4f matrix, float tick) {
        ...
        for (int h = 0; h < 6; h++) {
            ...
            for (int i = 0; i < segments; i++) {
                ...
                float r = 0.02f + 0.06f * heightFactor;
                float g = 0.0f;
                float b = 0.0f;
                ...
                addVertex(consumer, matrix, x2, y2, z2, r * 1.5f, g, b, alpha);
                addVertex(consumer, matrix, x1, y2, z1, r * 1.5f, g, b, alpha);
            }
        }
    }
    ...
    private class DarknessLayer {
        ...
        DarknessLayer(int index) {
            ...
            this.redIntensity = random.nextFloat();
        }
    ...
    private class VoidParticle {
        ...
        VoidParticle() {
            ...
            this.r = 0.02f + random.nextFloat() * 0.05f;
            this.g = 0.0f;
            this.b = 0.0f;
        }
