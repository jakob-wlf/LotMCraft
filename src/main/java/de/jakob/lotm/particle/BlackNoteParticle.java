...
public class BlackNoteParticle extends TextureSheetParticle {
    protected BlackNoteParticle(ClientLevel level, double x, double y, double z, double color) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            BlackNoteParticle noteparticle = new BlackNoteParticle(level, x, y, z, xSpeed);
